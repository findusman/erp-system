...
{
      public partial class rpt_VCH_INVOICE : DevExpress.XtraReports.UI.XtraReport
      {
            string PRODUCT_ID = "";

            public rpt_VCH_INVOICE(string pPRODUCT_ID)
            {
                  InitializeComponent();
                  PRODUCT_ID = pPRODUCT_ID;

                  this.sp_TBL_VCH_MAIN_selectionTableAdapter.Connection.ConnectionString = DAL.DALCustome.connectionstring;
            ...
            private void rpt_DETAIL_SALE_INVOICE_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
            {
                  ...
                  //double ssss = Convert.ToDouble(this.GetCurrentColumnValue("SALES_AND_RETURN_MAIN_totalPayableAmount").ToString());
            ...
            private void rpt_DETAIL_SALE_INVOICE_DataSourceDemanded(object sender, EventArgs e)
            {
                  this.sp_TBL_VCH_MAIN_selectionTableAdapter.Fill(

               this.dataSet1_VCH1.sp_TBL_VCH_MAIN_selection ,
               "R",
               GEN.GEN_GEN.GenericClasses.cls_GENGlobalClass.GV_CMP_ID,
               GEN.GEN_GEN.GenericClasses.cls_GENGlobalClass.GV_BRC_ID,
               PRODUCT_ID,
