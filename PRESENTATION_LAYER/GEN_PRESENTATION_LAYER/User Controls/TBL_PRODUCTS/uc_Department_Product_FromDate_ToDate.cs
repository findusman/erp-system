...
{
      public partial class uc_Department_Product_FromDate_ToDate : DevExpress.XtraEditors.XtraUserControl
      {
            public uc_Department_Product_FromDate_ToDate()
            {
                  InitializeComponent();
                  loadGrid();
            ...
            public int? Pro_tempCOA_levelNo = 4;
            ...
            public bool? Pro_tempCOA_IsTransaction = true;
