...
namespace GEN.GEN_GEN.GenericClasses.Grid
{
    ...
    public class Gen_GridView
    {
       ...
       public DevExpress.XtraTreeList.TreeList ObjTreelist = new TreeList();
        ...
        public DevExpress.XtraGrid.GridControl Grid_Control =  new DevExpress.XtraGrid.GridControl();
        ...
        private void FAdddeletionTreeList()
        {
            ...
            ObjTreelist.Columns["D"].ColumnEdit = btn;
        ...
        private void Del_Btn_ClickTreeList(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ObjTreelist.Nodes.Remove(ObjTreelist.FocusedNode);
                //DataTable tCxC = (DataTable)ObjTreelist.DataSource;
                //tCxC.Rows.RemoveAt(ObjTreelist.FocusedNode.Id);
...
namespace Gen_GridViewSub
 {
     ...
     internal class Gen_Formating
    {
         ...
         public static String N1 = "n1";//"#.0";
         public static String N2 = "n2"; //"#.00";
         public static String N3 = "N1";//"#.000";
         public static String N4 = "n4";//"#.0000";
         public static String N5 = "";//"#.00000";

         public static String D3 = "";//"yyyy/MM/dd";
         public static String D2 = "";//"yyyy/dd/MM";
         public static String D4 = "";//"dd/MM/yyyy";
         public static String D1 = "";//"MM/dd/yyyy";
         public static String D5 = "";//"yyyy/MM/dd HH:mm:ss";


         String SA = "A: {0:n2}";
         String SS = "S: {0:n2}";
         String ST = "Total Records: {0}";
                 ...
                 for (int x = 0; x < TreeView.Columns.Count; x++)
                 {
                     ...
                     if (ArrTags[2] == "Y")
                     {
                         ...
                         if (TreeView.FocusedNode.GetValue(ColToValid).ToString() == string.Empty)
                         {
                             ...
                             e.Valid = false;
                             //gridview.SetColumnError(ColToValid, "Null Value Not Allowed");
                             TreeView.SetColumnError(ColToValid,"Null Value Not Allowed");
                           //  e.ErrorText = "Null Value Not Allowed";
                             break;
         ...
         public void SetGridFormat(GEN.GEN_GEN.GenericClasses.Grid.Gen_GridView.GRIDTYPE GridType)
        {
            ...
            if (GridType == GEN.GEN_GEN.GenericClasses.Grid.Gen_GridView.GRIDTYPE.GridView)
            {
                ...
                for (int x = 0; x < gridview.Columns.Count ; x++)
                {
                    ...
                    if (ArrTags[0] == "N1")
                    {
                        ...
                        gridview.Columns[x].DisplayFormat.FormatString = formatForSummary = N1;
                        //gridview.Columns[x].= N1;
                    ...
                    else if (ArrTags[0] == "N2")
                    {
                        ...
                        gridview.Columns[x].DisplayFormat.FormatType = FormatType.Numeric;
                        gridview.Columns[x].DisplayFormat.FormatString = formatForSummary = N2;
                    }
                    ...
                    else if (ArrTags[0] == "N3")
                    {
                        ...
                        gridview.Columns[x].DisplayFormat.FormatType = FormatType.Numeric;
                        gridview.Columns[x].DisplayFormat.FormatString = formatForSummary = N3;
                    }
                    ...
                    else if (ArrTags[0] == "N4")
                    {
                        ...
                        gridview.Columns[x].DisplayFormat.FormatType = FormatType.Numeric;
                        gridview.Columns[x].DisplayFormat.FormatString = formatForSummary = N4;
                    }
                    ...
                    else if (ArrTags[0] == "N5")
                    {
                        ...
                        gridview.Columns[x].DisplayFormat.FormatType = FormatType.Numeric;
                        gridview.Columns[x].DisplayFormat.FormatString = formatForSummary = N5;
                    }
                    ...
                    if (ArrTags[1] == "S")
                    {
                          ...
                          gridview.Columns[x].SummaryItem.DisplayFormat = "{0:"+formatForSummary+"}" ;
                    ...
                    else if (ArrTags[1] == "M")
                    {
                          ...
                          //gridview.Columns[x].SummaryItem.DisplayFormat = formatForSummary;
            ...
            else if (GridType == GEN.GEN_GEN.GenericClasses.Grid.Gen_GridView.GRIDTYPE.Banded)
            {
            ...
            else if (GridType == GEN.GEN_GEN.GenericClasses.Grid.Gen_GridView.GRIDTYPE.AdvBanded)
            {
            ...
            else if (GridType == GEN.GEN_GEN.GenericClasses.Grid.Gen_GridView.GRIDTYPE.TreeList)
            {
                    ...
                    if (Tree_View.Focused == true)
                    {
                        ...
                        if (e.KeyCode == Keys.Enter)
                        {
                            ...
                            if (Tree_View.FocusedColumn.VisibleIndex < Tree_View.VisibleColumns.Count - 1)
                            {
                                ...
                                int index =   Tree_View.VisibleColumns[Tree_View.FocusedColumn.VisibleIndex +1 ].AbsoluteIndex;
                                Tree_View.FocusedColumn = Tree_View.Columns[index];
                            }
                            else
                            {
