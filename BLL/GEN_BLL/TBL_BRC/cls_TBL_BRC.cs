...
namespace BLL.GEN_BLL.TBL_BRC
{

  public class cls_TBL_BRC
    {
        ...
        private  string  pBRC_ID   = string.Empty;
        ...
        private  string  pBRC_name  = string.Empty;
        public  string  BRC_name
        {
              get { return pBRC_name; }
              set {pBRC_name = value; }
        }


        private  string  pBRC_address  = string.Empty;
        public  string  BRC_address
        {
              get { return pBRC_address; }
              set {pBRC_address = value; }
        }


        private  string  pBRC_adminUserID  = string.Empty;
        public  string  BRC_adminUserID
        {
              get { return pBRC_adminUserID; }
              set {pBRC_adminUserID = value; }
        }


        private  string  pBRC_phoneNumber  = string.Empty;
        public  string  BRC_phoneNumber
        {
              get { return pBRC_phoneNumber; }
              set {pBRC_phoneNumber = value; }
        }


        private  string  pBRC_narration  = string.Empty;
        public  string  BRC_narration
        {
              get { return pBRC_narration; }
              set {pBRC_narration = value; }
        }
        ...
        public bool insertionUpdation(char pProcedureStatus)
        {
              ...
              else
              {
                    ...
                    BRC_adminUserID = ds.Tables[0].Rows[0][1].ToString();



                    if (BRC_adminUserID != "N" && ExeState == "ok")
                    { }
                    else
                    {
            ...
            sql_param[2] = new SqlParameter("@BRC_name", SqlDbType.NVarChar);
            sql_param[2].Value = BRC_name;

            sql_param[3] = new SqlParameter("@BRC_address", SqlDbType.NVarChar);
            sql_param[3].Value = BRC_address;

            sql_param[4] = new SqlParameter("@BRC_adminUserID", SqlDbType.NVarChar);
            sql_param[4].Value = BRC_adminUserID;

            sql_param[5] = new SqlParameter("@BRC_phoneNumber", SqlDbType.NVarChar);
            sql_param[5].Value = BRC_phoneNumber;

            sql_param[6] = new SqlParameter("@BRC_narration", SqlDbType.NVarChar);
            sql_param[6].Value = BRC_narration;
            ...
            if (pProcedureStatus == 'I')
              ds = obj_DALCustome.selection("sp_TBL_BRC_insertion", sql_param, obj_SqlCommand, true);
            else
                ds = obj_DALCustome.selection("sp_TBL_BRC_updation", sql_param, obj_SqlCommand, true);
            if (GEN.GEN_GEN.GenericClasses.DataTables.cls_NativDataSet.checkIsNullIsNoTableIsTableEmpty(ds, 0))
            {
       ...
       public bool deletion()
        {
            ...
            if (Status != "ok")
            {
                ...
                DataSet ds = obj_DALCustome.selection("sp_TBL_BRC_deletion", sql_param, obj_SqlCommand, true);
        ...
        public DataSet selection()
        {
            ...
            sql_param[3] = new SqlParameter("@Is_Deleted", SqlDbType.Bit);
            sql_param[3].Value = GEN.GEN_GEN.GenericClasses.cls_GENGlobalClass.GV_isDeleted;

            DataSet ds = obj_DALCustome .selection("sp_TBL_BRC_selection", sql_param,obj_SqlCommand ,true);
