...
namespace BLL.GEN_BLL.TBL_KEYS_TYPES
{

  public class cls_TBL_KEYS_TYPES
    {
        ...
        private  string  pKEYS_TYPES_ID   = string.Empty;
 
        public  string  KEYS_TYPES_ID   
        {
              get { return pKEYS_TYPES_ID ; }
              set { pKEYS_TYPES_ID  = value ; }
        }

        


        private  string  pKEYS_TYPES_name  = string.Empty;
        public  string  KEYS_TYPES_name
        {
              get { return pKEYS_TYPES_name; }
              set {pKEYS_TYPES_name = value; }
        }


        private  bool  pKEYS_TYPES_isActive  = true;
        public  bool  KEYS_TYPES_isActive
        {
              get { return pKEYS_TYPES_isActive; }
              set {pKEYS_TYPES_isActive = value; }
        }


        private  string  pKEYS_TYPES_description  = string.Empty;
        public  string  KEYS_TYPES_description
        {
              get { return pKEYS_TYPES_description; }
              set {pKEYS_TYPES_description = value; }
        }
        ...
        public bool insertionUpdation(char pProcedureStatus)
        {
            ...
            sql_param[2] = new SqlParameter("@KEYS_TYPES_ID ", SqlDbType.NVarChar);
            sql_param[2].Value = KEYS_TYPES_ID ;


sql_param[3] = new SqlParameter("@KEYS_TYPES_name", SqlDbType.NVarChar);
sql_param[3].Value = KEYS_TYPES_name;

sql_param[4] = new SqlParameter("@KEYS_TYPES_isActive", SqlDbType.Bit);
sql_param[4].Value = KEYS_TYPES_isActive;

sql_param[5] = new SqlParameter("@KEYS_TYPES_description", SqlDbType.NVarChar);
sql_param[5].Value = KEYS_TYPES_description;
            ...
            if (pProcedureStatus == 'I')
              ds = obj_DALCustome.selection("sp_TBL_KEYS_TYPES_insertion", sql_param, obj_SqlCommand, true);
            else
                ds = obj_DALCustome.selection("sp_TBL_KEYS_TYPES_updation", sql_param, obj_SqlCommand, true);
       ...
       public bool deletion()
        {
            ...
            sql_param[3] = new SqlParameter("@KEYS_TYPES_ID ", SqlDbType.NVarChar);
            sql_param[3].Value = KEYS_TYPES_ID ;
            ...
            if (Status != "ok")
            {
                ...
                DataSet ds = obj_DALCustome.selection("sp_TBL_KEYS_TYPES_deletion", sql_param, obj_SqlCommand, true);
        ...
        public DataSet selection()
        {
            ...
            DataSet ds = obj_DALCustome .selection("sp_TBL_KEYS_TYPES_selection", sql_param,obj_SqlCommand ,true);
