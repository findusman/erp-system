...
namespace BLL.IMS_BLL.TBL_SUPPLIERS
{

    public class cls_TBL_SUPPLIERS
    {
        ...
        public bool insertionUpdation(char pProcedureStatus)
        {
            ...
            if (pProcedureStatus == 'I')
            {
                ...
                dsCOA = obj.insertionDirect(1, GEN.GEN_GEN.GenericClasses.cls_KeysWithValue.Parent_Of_Supplier, "", 0, SUPPLIER_name, 0, "", true, "Insertion", "Child", false, true);
                ...
                SUPPLIER_COA = dsCOA.Tables[0].Rows[0][1].ToString(); 
            }
            ...
            if (pProcedureStatus == 'I')
                ds = obj_DALCustome.selection("sp_TBL_SUPPLIERS_insertion", sql_param, obj_SqlCommand, true);
            else
                ds = obj_DALCustome.selection("sp_TBL_SUPPLIERS_updation", sql_param, obj_SqlCommand, true);
        ...
        public bool deletion()
        {
            ...
            DataSet ds = obj_DALCustome.selection("sp_TBL_SUPPLIERS_deletion", sql_param, obj_SqlCommand, true);
        ...
        public DataSet selection()
        {
            ...
            DataSet ds = obj_DALCustome.selection("sp_TBL_SUPPLIERS_selection", sql_param, obj_SqlCommand, true);
