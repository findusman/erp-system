...
namespace BLL.IMS_BLL.TBL_VEHICLE_MAKERS
{

    public class cls_TBL_VEHICLE_MAKERS
    {
        ...
        private string pVEHICLE_MAKER_ID = string.Empty;

        public string VEHICLE_MAKER_ID
        {
            get { return pVEHICLE_MAKER_ID; }
            set { pVEHICLE_MAKER_ID = value; }
        }




        private string pVEHICLE_MAKER_name = string.Empty;
        public string VEHICLE_MAKER_name
        {
            get { return pVEHICLE_MAKER_name; }
            set { pVEHICLE_MAKER_name = value; }
        }


        private string pVEHICLE_MAKER_narration = string.Empty;
        public string VEHICLE_MAKER_narration
        {
            get { return pVEHICLE_MAKER_narration; }
            set { pVEHICLE_MAKER_narration = value; }
        }
        ...
        public bool insertionUpdation(char pProcedureStatus)
        {
            ...
            sql_param[2] = new SqlParameter("@VEHICLE_MAKER_ID ", SqlDbType.NVarChar);
            sql_param[2].Value = VEHICLE_MAKER_ID;


            sql_param[3] = new SqlParameter("@VEHICLE_MAKER_name", SqlDbType.NVarChar);
            sql_param[3].Value = VEHICLE_MAKER_name;

            sql_param[4] = new SqlParameter("@VEHICLE_MAKER_narration", SqlDbType.NVarChar);
            sql_param[4].Value = VEHICLE_MAKER_narration;
            ...
            if (pProcedureStatus == 'I')
                ds = obj_DALCustome.selection("sp_TBL_VEHICLE_MAKERS_insertion", sql_param, obj_SqlCommand, true);
            else
                ds = obj_DALCustome.selection("sp_TBL_VEHICLE_MAKERS_updation", sql_param, obj_SqlCommand, true);
        ...
        public bool deletion()
        {
            ...
            sql_param[3] = new SqlParameter("@VEHICLE_MAKER_ID ", SqlDbType.NVarChar);
            sql_param[3].Value = VEHICLE_MAKER_ID;
            ...
            DataSet ds = obj_DALCustome.selection("sp_TBL_VEHICLE_MAKERS_deletion", sql_param, obj_SqlCommand, true);
        ...
        public DataSet selection()
        {
            ...
            DataSet ds = obj_DALCustome.selection("sp_TBL_VEHICLE_MAKERS_selection", sql_param, obj_SqlCommand, true);
